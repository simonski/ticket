        ...
        const els = {
            ...
            systemAgentURL: document.getElementById("system-agent-url"),
            systemAgentAPIKey: document.getElementById("system-agent-api-key"),
            projectAgentURL: document.getElementById("project-agent-url"),
            projectAgentAPIKey: document.getElementById("project-agent-api-key"),
