...
- `make test-browser` runs the fast browser smoke Playwright suite.
- `make test-browser-full` runs the full browser E2E Playwright suite.
...
- If web UI changes: run `make test-browser` while iterating, then `make test-browser-full`.
