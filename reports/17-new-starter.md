...
Onboarding effectiveness from the perspective of a day-one engineer: reading order, way of working, setup speed, ticket workflow, testing expectations, collaboration, common pitfalls, and documentation completeness.
...
### Passing checks
- `docs/ONBOARDING.md` exists and is well structured: reading order, dev setup, ticket workflow, test conventions, collaboration, common pitfalls table (`docs/ONBOARDING.md`)
...
- `tk` ticket workflow documented: `tk ls`, `tk start`, `tk state`, `tk close` (`ONBOARDING.md:58-80`)
...
- `tk init` now reports workflow/role status post-setup — reduces "why isn't anything working" confusion
